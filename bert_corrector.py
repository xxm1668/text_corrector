...
if __name__ == "__main__":
    ...
    for sent in error_sentencess.keys():
        ...
        print("耗时 %s seconds" % (time.time() - _start))
    ...
    while 1:
        text = input("请输入query问句：")
        corrected_sent, err = d.bert_correct(text)
        print("original sentence:{} => {}, err:{}".format(text, corrected_sent, err))
